#ifndef __SKELETALMESHLOD_H__
#define __SKELETALMESHLOD_H__
...
class GOKNAR_API SkeletalMeshLOD : public MeshSection<SkeletalMeshGeometry>
{
public:
	SkeletalMeshLOD();

	virtual ~SkeletalMeshLOD();

    virtual void PreInit() override;
    virtual void Init() override;
    virtual void PostInit() override;

    virtual void AddMesh(SkeletalMeshGeometry* meshUnit) override;
