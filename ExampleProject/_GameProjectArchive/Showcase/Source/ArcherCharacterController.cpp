	...
	archer_(archer)
{
	...
	toggleFreeCameraDelegate_ = KeyboardDelegate::Create<ArcherCharacterController, &ArcherCharacterController::ToggleFreeCamera>(this);
...
void ArcherCharacterController::BindInputDelegates()
{
	...
	inputManager->AddKeyboardInputDelegate(KEY_MAP::F2, INPUT_ACTION::G_RELEASE, toggleFreeCameraDelegate_);
...
void ArcherCharacterController::UnbindInputDelegates()
{
	...
	inputManager->RemoveKeyboardInputDelegate(KEY_MAP::F2, INPUT_ACTION::G_RELEASE, toggleFreeCameraDelegate_);
